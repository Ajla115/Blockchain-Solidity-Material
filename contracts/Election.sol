...
contract Election {
    ...
    //Added
    function getNumberOfOwners() external view returns (uint){
        return numOwners;
    }

    //Added
    function getOwner(address _addr) external view returns (bool) {
        return owners[_addr];
    }

    //Added
    //I dont need this function because I have startVoting function
    ...
    function getCandidate(address _addr) external view returns (bool) {
